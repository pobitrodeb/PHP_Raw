<?php include "includes/header.php"; ?>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            <div class="row">
                <?php foreach ($products as $bitm) { ?>
                <div class="col-md-3 mb-4">
                    <div class="card">
                        <img src="assets/img/<?php echo $bitm['image']; ?>" alt="" class="card-img-top h-250"/>
                        <div class="card-body">
                            <h5><?php echo $bitm['name']; ?></h5>
                            <p>TK. <?php echo $bitm['price']; ?></p>
                            <hr/>
                            <a href="action.php?page=detail&id=<?php echo $bitm['id']; ?>" class="btn btn-success">Detail</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
